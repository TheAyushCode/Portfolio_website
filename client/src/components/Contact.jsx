  ...
  return (
    <section id="contact" className="py-24 px-6 max-w-7xl mx-auto border-t border-zinc-900">
      ...
      <div className="grid sm:grid-cols-3 gap-6 mb-16">
        ...
        <a href="https://www.linkedin.com/in/theayushcode/" target="_blank" rel="noreferrer" className="bg-[#0e131f] border border-cyan-950/60 p-6 rounded-2xl flex flex-col items-center text-center hover:border-cyan-400/40 transition">

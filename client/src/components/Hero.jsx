        ...
        <div className="lg:col-span-7 flex flex-col items-start">
          ...
          <div className="flex flex-wrap items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              <a href="https://www.linkedin.com/in/theayushcode/" target="_blank" rel="noreferrer" className="p-3 bg-zinc-900 border border-zinc-800 rounded-xl text-zinc-400 hover:text-cyan-400 transition">
              ...
              <a href="https://www.hackerrank.com/profile/TheAyushCode_X" target="_blank" rel="noreferrer" className="p-3 bg-zinc-900 border border-zinc-800 rounded-xl text-zinc-400 hover:text-green-400 transition" aria-label="HackerRank"> 
                <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24" ><path d="M12 2.5C6.75 2.5 2.5 6.75 2.5 12S6.75 21.5 12 21.5 21.5 17.25 21.5 12 17.25 2.5 12 2.5Zm4.5 13.2h-3.1v-2.1h-2.8v2.1H7.5v-2.1h3.1v-3.2H7.5V8.3h3.1v-2h2.8v2h3.1v2.1h-3.1v3.2h3.1v2.1Z" /></svg>
              </a>
            </div>
          </div>
        </div>
